...
Desarrollador Full Stack Junior con formación académica (SoyHenry + UTN) y experiencia práctica en desarrollo web tanto en frontend como backend. Apasionado por la programación, el aprendizaje continuo y la resolución de problemas. Manejo de tecnologías como JavaScript, C++, C#, React, Node.js, SQL y Git. Nivel de inglés C2 certificado. Buscando oportunidades para aplicar mis habilidades y seguir creciendo profesionalmente.
...
Inglés: Nivel C2 - Proficient (certificado EF SET: https://www.efset.org/cert/59jYBd)
